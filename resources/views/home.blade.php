...
@section('content')
    ...
    <div id="skeleton" class="w-full">
        <div class="animate-pulse grid grid-cols-1 place-items-center">
            <div class="h-[550px] bg-gray-100 rounded-xl mt-36 w-[1300px]"></div>
            <div class="h-12 bg-gray-100 rounded-xl mt-20 w-1/2"></div>
            <div class="h-12 bg-gray-100 rounded-xl mt-4 w-3/4"></div>
            <div class="grid grid-cols-3 gap-2 mt-4 w-full place-items-center">
                <div class="h-48 bg-gray-100 rounded-xl w-64"></div>
                <div class="h-48 bg-gray-100 rounded-xl w-64"></div>
                <div class="h-48 bg-gray-100 rounded-xl w-64"></div>
            </div>  
            <div class="grid grid-cols-2 gap-20 mt-32 place-items-center">
                <div class="h-72 bg-gray-100 rounded-xl w-72"></div>
                <div class="h-72 bg-gray-100 rounded-xl w-72"></div>
            </div>
            <div class="h-48 bg-gray-100 rounded-xl w-64 my-10"></div>
            <div class="grid grid-cols-2 gap-1 mt-20 w-full place-items-center">
                <div class="h-48 bg-gray-100 rounded-xl w-64"></div>
                <div class="h-48 bg-gray-100 rounded-xl w-64"></div>
            </div> 
            <div class="h-20 bg-gray-100 rounded-xl w-3/4 my-10"></div>
            <div class="h-[550px] bg-gray-100 rounded-xl my-20 w-3/4"></div>
        </div>
    </div>    
    ...
    <div id="content" class="hidden">
        ...
        <section id="optimizing" class="md:my-40 my-20">
            ...
            <div id="info" class="my-20 md:my-40 flex flex-col md:flex-row md:mx-52 justify-center items-center">
                ...
                <div class="">
                    ...
                    <div class="flex flex-row items-center space-x-4 mb-8">
                        <p class="md:text-xl text-sm">focuses on increasing fish production through monitoring water
                            conditions
                        </p>
        ...
        <section class="md:my-40 my-20">
            ...
            <!-- alur/step -->
            <div
                class="flex flex-col sm:flex-row md:mt-20 mt-10 gap-8 mx-4 sm:mx-64 justify-center items-center text-center">
                {{-- step 1 --}}
                    ...
                    <div>
                        <div class="mb-10">
                            ...
                            <p class="text-gray-500">Aquanova is an advanced aquaculture system designed to
                                monitor and optimize water conditions in aquaculture environments. It tracks key parameters
                                such
                                as temperature, pH, oxygen levels, and salinity to ensure the health and productivity of
                                aquatic
                                species.</p>
                        </div>
                        <div class="mb-10">
                        ...
                        <div class="mb-10">
                            ...
                            <p class="text-gray-500 ">Aquanova collects data through integrated sensors that
                                continuously measure water parameters. This data is then recorded and analyzed to assess
                                water
                    ...
                    <div>
                        <div class="mb-10">
                            ...
                            <p class="text-gray-500 ">Aquanova updates its data in real-time or at specified
                                intervals, depending on the configuration and needs of the aquaculture system. This ensures
                                that
