...
@section('content')
    ...
    <header class="md:mt-36 md:mx-20 sm:-mx-20 mt-20">
        ...
        <button id="scrollButton"
            class="flex justify-center items-center mx-auto md:ml-[950px] md:mt-2 mt-16 rounded-full bg-gradient-to-r from-[#6FCDF7] to-[#D3E2FF] text-white md:px-6 py-3 md:w-[211px] w-40 md:h-[60px] h-14 text-sm md:text-lg font-medium transition-all duration-300 hover:shadow-lg hover:opacity-90 space-x-3">
            <span>Start Now</span>
